...
public class CRC16M {
	...
	public void update(byte[] puchMsg, int usDataLen) {
		...
		System.out.println("uchCRCHi"+String.format("0x%04x",(0xff&uchCRCHi))+" " + "uchCRCLo" + String.format("0x%04x",(0xff&uchCRCLo)));
		value = ((((int) uchCRCHi) << 8 | (((int) uchCRCLo) & 0xff))) & 0xffff;//µÍÎ»ÔÚÇ°
		System.out.println("value:"+String.format("0x%04x",(0xffff&value)));
		return;
	...
	public static void main(String[] args) {
		...
		byte[] sbuf = CRC16M.getSendBuf("02050003FF01");
